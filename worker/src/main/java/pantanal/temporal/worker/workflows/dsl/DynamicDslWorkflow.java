...
import pantanal.temporal.worker.workflows.dsl.model.WorkflowData;
import pantanal.temporal.worker.workflows.dsl.utils.DslWorkflowUtils;
import pantanal.temporal.worker.workflows.dsl.utils.JQFilter;
...
public class DynamicDslWorkflow implements DynamicWorkflow {
  ...
  public Object execute(EncodedValues args) {
    ...
    State startingState = WorkflowUtils.getStartingState(dslWorkflow);
    executeDslWorkflowFrom(startingState);
